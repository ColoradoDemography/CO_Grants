...
module.exports = function(map: Object) {
    ...
    map.openModal({
        content: '<table class="abbrev">' +
            ...
            '<tr><td><span class="ttext">IHOI:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://cdola.colorado.gov/1271" class="blue" target="_blank" >Housing Incentives Grant Program</a></span></td></tr>' +
            '<tr><td><span class="ttext">IHOP:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://cdola.colorado.gov/1271" class="blue" target="_blank" >Housing Planning Grant Program</a></span></td></tr>' +
            ...
            '<tr><td><span class="ttext">SBR:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://cdola.colorado.gov/small-business-relief" class="blue" target="_blank" >Small Business Relief Program</a></span></td></tr>' +
