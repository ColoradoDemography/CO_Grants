...
module.exports = function(map: Object) {
    ...
    map.openModal({
        content: '<table class="abbrev">' +
            ...
            '<tr><td><span class="ttext">FML:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://cdola.colorado.gov/funding-programs/direct-distribution-severance-tax-federal-mineral-lease" class="blue" target="_blank" >Direct Distribution of Federal Mineral Lease Dollars</a></span></td></tr>' +
            ...
            '<tr><td><span class="ttext">SEV:</span></td><td><span class="desctext">&nbsp;&nbsp;<a href="https://cdola.colorado.gov/funding-programs/direct-distribution-severance-tax-federal-mineral-lease" class="blue" target="_blank" >Direct Distribution of Severance Tax Dollars</a></span></td></tr>' +
